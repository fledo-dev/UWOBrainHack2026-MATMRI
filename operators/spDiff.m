function y = spDiff(u,transp,dimScale,imMask,diffScale)
%
% y = spDiff(u,transp,sz_im,dimScale,imMask,diffScale)
%
...
%   diffScale (optional): scale the difference maps by diffScale, which
%       should have same array size as image
%
% (C) Corey Baron 2018
%
